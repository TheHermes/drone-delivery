...
public class UI {
    ...
    public static String promptPlace(String message, ArrayList<Node> data) {
        ...
        while (true) {
            ...
            Node node = Utils.getNodeByKey(data, input);
            if (node != null) {
                return input; // Return valid place key
            } else {
